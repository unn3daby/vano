            ...
            <div class="header__navbar">
                <div class="header__menu--left-side">
                    <router-link to="/" active-class="">
                        <img class="header__menu--logo" src="@/assets/imgs/header/main_logo.svg" alt="Food delivery website logo" />
                    </router-link>
                ...
                <div class="header__menu--right-side">
                    <nav class="header__menu--link">
                        <router-link class="menu_link" :to="{name: 'restaurants'}" active-class="active">Restaurants</router-link>
                        ...
                        <router-link class="menu_link" :to="{name: 'home'}" active-class="active">My orders</router-link>
                    </nav>
                    <div class="header__menu--icon">
                        <router-link :to="{name: 'home'}"><img class="header__menu--icon-item" src="@/assets/imgs/header/shopping_bag.svg"
                                alt="shopping bag icon" />
                        </router-link>
                        <span class="header__menu--icon-number">4</span>
                    </div>
                    <router-link :to="{name: 'home'}">
                        <img class="header__menu--useravatar" src="@/assets/imgs/header/useravatar.svg" alt="useravatar img" />
                    </router-link>
                    <span class="header__menu--divider-vertical"></span>
                    <img class="header__menu--icon-mobile menu-icon" src="@/assets/imgs/header/menu.svg" alt=" header menu icon " />
                </div>
            </div>
        </div>
    </header>

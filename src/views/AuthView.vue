        ...
        <div class="login_container">
            <div class="block_left-side">
                <div class="auth_form">
                    ...
                    <div class="sign">
                        <p>Нет аккаунта?<a href="#" class="sign_inner"> Зарегистрироваться</a></p> 
                    </div>
                </div>   
            </div>
            <div class="block_right-side">
                <div class="block_right-inner">
                    ...
                    <div class="block_right--text">Connecting Alumni and of Govermment engineering college idukki to a next level</div>
                    <div class="circle">
...
.button_login:hover {
    background-color: var(--bluw-light);
}
